...
namespace Substrate
{
    ...
    public class TileTick : INbtObject<TileTick>, ICopyable<TileTick>
    {
        ...
        public static TileTick FromTreeSafe (TagNode tree, out NbtErrors errors)
        {
            return new TileTick().LoadTreeSafe(tree, out errors);
        }
        ...
        public TileTick LoadTreeSafe (TagNode tree, out NbtErrors errors)
        {
